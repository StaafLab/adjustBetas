...
legend("bottomleft",legend=c("FlexMix sample group concordance","Adj-Adj sample correlation","Norm-iNorm sample correlation"),
...
xx$y<-xx$y/max(xx$y)
lines(xx,col="orange",lwd=2)

legend("topleft",legend=paste(c("Unadj tumor (median r=","Adj tumor (median r=","iNorm (median r="),
